...
TestWorkflowDocumentTabPanelListTableRow.propTypes = {
...
export default function TestWorkflowDocumentTabPanelListTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow, onDownloadDocument, selectedColumns }) {
    ...
    return (
        <>
            <TableRow hover selected={selected}>
                ...
                {selectedColumns.docOriginalname &&
                    <TableCell>
