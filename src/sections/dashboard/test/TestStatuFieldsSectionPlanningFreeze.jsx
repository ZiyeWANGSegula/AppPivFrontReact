...
TestStatuFieldsSectionPlanningFreeze.propTypes = {
...
export default function TestStatuFieldsSectionPlanningFreeze({ title, stepData, entity, estimatedDate, testId, onValidateStateChange, stepName, stepValidated }) {
    ...
    console.log('stepData of planning freez')
    ...
    const onSubmit = (data) => {
        data.step = `PLANNING_FREEZE_${entity.toUpperCase()}`;
        data.id = testId
    ...
    useEffect(() => {
        const params = {
            ...
            field: `PLANNING_FREEZE_${entity.toUpperCase()}`,
        };
        console.log('params');
        console.log(params);
        ...
        const getCommentParams = {
            ...
            testStatus: `PLANNING_FREEZE`,
            testStatusField: `PLANNING_FREEZE_${entity.toUpperCase()}`,
        };
        console.log('params');
        console.log(params);
    ...
    return (
        ...
        <Box sx={{ width: '100%', height: '100%', bgcolor: 'background.paper', display: 'flex', flexDirection: 'column' }}>
            ...
            <TabPanel value={tabValue} index={1}>
                <TestWorkflowDocumentTabPanelList stepName={`PLANNING_FREEZE_${entity.toUpperCase()}`} stepData={stepData} model={`ProjTest${stepName}`} entity={`test${stepName}`} setTotal={handleDocumentTotalChange}></TestWorkflowDocumentTabPanelList>
            </TabPanel>
            ...
            <TabPanel value={tabValue} index={3}>
                <TestWorkflowCommentTabPanelList stepName='PLANNING_FREEZE' stepData={stepData} entity={entity.toUpperCase()} setTotal={handleCommentTotalChange}></TestWorkflowCommentTabPanelList>
            </TabPanel>
