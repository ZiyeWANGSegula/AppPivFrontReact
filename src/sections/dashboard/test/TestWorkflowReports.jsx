...
export default function TestWorkflowReports({ onNextStep, onBackStep, currentTest, stepName }) {
    ...
    const flashStatus = currentTest[`ProjTest${stepName}`]['flashStatus']
    const completeStatus = currentTest[`ProjTest${stepName}`]['completeStatus']
    ...
    const sections = [
        {
            title: "Flash",
            entity: "flash",
            stepDataKey: "flashEstimAt",
            validateState: flashStatus,
        },
        {
            title: "Complete",
            entity: "complete",
            stepDataKey: "completeEstimAt",
            validateState: completeStatus,
        },
    ];
                ...
                >
                    ...
                    {sectionValidationStates.every((state) => state) && (
                        <Button
                            ...
                            sx={{ margin: 3 }}
                        >
                            {validateState ? 'Cancel validation' : 'Validate Test'}
                        </Button>
                    )}
