...
TestStatuFieldsSectionDelivery.propTypes = {
...
export default function TestStatuFieldsSectionDelivery({ title, stepData, entity, estimatedDate, testId, onValidateStateChange, stepName, stepValidated }) {
    ...
    const onSubmit = (data) => {
        data.step = `RECEPTION_${entity.toUpperCase()}`;
        data.id = testId
    ...
    useEffect(() => {
        const params = {
            ...
            field: `RECEPTION_${entity.toUpperCase()}`,
        };
        console.log('params');
        console.log(params);
        ...
        const getCommentParams = {
            ...
            testStatus: `RECEPTION`,
            testStatusField: `RECEPTION_${entity.toUpperCase()}`,
        };
        console.log('params');
        console.log(params);
    ...
    return (
        ...
        <Box sx={{ width: '100%', height: '100%', bgcolor: 'background.paper', display: 'flex', flexDirection: 'column' }}>
            ...
            <TabPanel value={tabValue} index={1}>
                <TestWorkflowDocumentTabPanelList stepName={`RECEPTION_${entity.toUpperCase()}`} stepData={stepData} model={`ProjTest${stepName}`} entity={`test${stepName}`} setTotal={handleDocumentTotalChange} ></TestWorkflowDocumentTabPanelList>
            </TabPanel>
