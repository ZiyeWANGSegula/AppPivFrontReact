...
TestStatuFieldsSectionTesting.propTypes = {
...
export default function TestStatuFieldsSectionTesting({ title, stepData, entity, estimatedDate, testId, onValidateStateChange, stepName,stepValidated }) {
    ...
    const onSubmit = (data) => {
        data.step = `TEST_COURSE_${entity.toUpperCase()}`;
        data.id = testId
    ...
    useEffect(() => {
        const params = {
            ...
            field: `TEST_COURSE_${entity.toUpperCase()}`,
        };
        console.log('params');
        console.log(params);
        ...
        const getCommentParams = {
            ...
            testStatus: `TEST_COURSE`,
            testStatusField: `TEST_COURSE_${entity.toUpperCase()}`,
        };
        console.log('params');
        console.log(params);
    ...
    return (
        ...
        <Box sx={{ width: '100%', height: '100%', bgcolor: 'background.paper', display: 'flex', flexDirection: 'column' }}>
            ...
            <TabPanel value={tabValue} index={1}>
                <TestWorkflowDocumentTabPanelList stepName={`TEST_COURSE_${entity.toUpperCase()}`} stepData={stepData} model={`ProjTest${stepName}`} entity={`test${stepName}`} setTotal={handleDocumentTotalChange} ></TestWorkflowDocumentTabPanelList>
            </TabPanel>
            ...
            <TabPanel value={tabValue} index={3}>
                <TestWorkflowCommentTabPanelList stepName='TEST_COURSE' stepData={stepData} entity={entity.toUpperCase()} setTotal={handleCommentTotalChange}></TestWorkflowCommentTabPanelList>
            </TabPanel>
