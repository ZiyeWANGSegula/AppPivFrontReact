...
export default function TestWorkflowTesting({ onNextStep, onBackStep, currentTest, stepName }) {
    ...
    const startStatus = currentTest[`ProjTest${stepName}`]['startStatus']
    const endStatus = currentTest[`ProjTest${stepName}`]['endStatus']
    ...
    const sections = [
        {
            title: "Start Date",
            entity: "start",
            stepDataKey: "startEstimAt",
            validateState: startStatus,
        },
        {
            title: "End Date",
            entity: "end",
            stepDataKey: "endEstimAt",
            validateState: endStatus,
        },
    ];
